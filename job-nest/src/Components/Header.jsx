      ...
      <div className="max-w-7xl h-16 mx-auto px-4 py-3 flex items-center justify-between">
        <div className="">
          <Link to='/'>
            ...
            <span className="w-10 h-10 bg-gradient-to-r from-[#5fa2d8] to-[#3f7fb0] rounded-lg p-3 mx-3 text-white font-bold">JN</span>
            <span className="font-display text-xl font-bold text-foreground">JOB NEST</span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="bg-gradient-to-r from-[#5fa2d8] to-[#3f7fb0]
